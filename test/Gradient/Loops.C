...
//CHECK-NEXT:                 if (clad::back(_cond1)) {
//CHECK-NEXT:                     clad::push(_t2, _cond0);
//CHECK-NEXT:                     clad::push(_t3, res);
...
//CHECK-NEXT:                     {
//CHECK-NEXT:                         if (clad::back(_cond1)) {
//CHECK-NEXT:                             _cond0 = clad::pop(_t2);
//CHECK-NEXT:                             double _r_d1 = _d_cond0;
//CHECK-NEXT:                             _d_cond0 -= _r_d1;
//CHECK-NEXT:                             _d_res += _r_d1;
//CHECK-NEXT:                             res = clad::pop(_t3);
//CHECK-NEXT:                             double _r_d2 = _d_res;
//CHECK-NEXT:                             *_d_i += _r_d2 * j;
...
int main() {
  ...
  TEST_2(fn30, 3, 5); // CHECK-EXEC: {10.00, 6.00}
