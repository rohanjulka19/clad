...
// CHECK-NEXT:                     res += i * j;
// CHECK-NEXT:                     {
// CHECK-NEXT:                         clad::push(_t2, 3UL);
// CHECK-NEXT:                         continue;
// CHECK-NEXT:                     }
// CHECK-NEXT:                 }
// CHECK-NEXT:             }
// CHECK-NEXT:             clad::push(_t2, 4UL);
// CHECK-NEXT:         }
// CHECK-NEXT:     _d_res += 1;
// CHECK-NEXT:     while (_t0)
// CHECK-NEXT:         {
...
// CHECK-NEXT: void f_loop_init_var_grad(double lower, double upper, double *_d_lower, double *_d_upper) {
...
// CHECK-NEXT:     clad::array<double> arr(1UL);
// CHECK-NEXT:     clad::tape<double> _t2 = {};
// CHECK-NEXT:     clad::tape<double> _t3 = {};
